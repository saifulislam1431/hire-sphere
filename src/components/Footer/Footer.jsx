            ...
            <section>
                ...
                <div className='my-footer'>
                    ...
                    <div className='flex flex-col lg:flex-row items-center justify-between mt-5'>
                        <p className='text-sm text-gray-400'>@2023 <span className='font-bold'>HireSphere.</span> All Right Reserved</p>
                        <p className='text-sm text-gray-400'>Powered by <span className='font-bold'>HireSphere</span></p>
                    </div>
